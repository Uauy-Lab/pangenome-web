...
class GenesControllerTest < ActionController::TestCase
  ...
  test "should create gene" do
    assert_difference('Gene.count') do
      post :create, gene: { cdna: @gene.cdna, gene: @gene.gene, geneSet: @gene.geneSet, name: @gene.name, possition: @gene.possition, transcript: @gene.transcript }
    end
  ...
  test "should update gene" do
    patch :update, id: @gene, gene: { cdna: @gene.cdna, gene: @gene.gene, geneSet: @gene.geneSet, name: @gene.name, possition: @gene.possition, transcript: @gene.transcript }
    assert_redirected_to gene_path(assigns(:gene))
  end
