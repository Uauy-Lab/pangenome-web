...
class SearchBox {
  ...
  constructor(div, url, current_status, prefix) {
    this.#outerdiv = div.append("div").style("display", "inline-block");
    this.#url = url;
  ...
  render() {
    this.#div = this.#outerdiv.append("div").style("display", "inline-block");
    this.#input = this.#div
      .append("input")
      .attr("type", "text")
    ...
    this.#features_div = this.#outerdiv
      .append("div")
  ...
  set datalist(vals) {
    this.#datalist
      .selectAll("option")
      .data(vals)
      .join((enter) => enter.append("option").attr("value", (d) => d));
  }
